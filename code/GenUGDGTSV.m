...
for r = 0:1
   ...
   fname = sprintf('sub-%03d_task-ugdg_run-%d_events.tsv',subj,r+1); % making compatible with bids output
...
%% This is for subject 1248, which used psychopy2


% This is the final bids converter used.

% The debugging code is for participants that used psychopy 2 instead of 3.
